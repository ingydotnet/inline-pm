...
When you first start writing C code, it's easy to introduce memory leaks. This
section will give you a few simple pointers for avoiding memory leaks. For
more detailed examples showing these techniques, see L<Inline::C-Cookbook>.
